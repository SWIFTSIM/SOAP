...
class PropertyTable:
    ...
    # TODO: Add footnote on inflow/outflow calculations
    }
    ...
    full_property_list = {
        ...
        "DarkMatterMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            # TODO: Put info about different components in footnote?
            "Mass flux of dark matter particles through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            # TODO: What filter do we want?
            "general",
            "FMantissa9",
            True,
            [
        ...
        "GasMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flux of gas particles through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "ColdGasMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flux of cold gas particles (log T < 3) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "CoolGasMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flux of cool gas particles (3 < log T < 5) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "WarmGasMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flux of warm gas particles (5 < log T < 7) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "HotGasMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flux of hot gas particles (7 < log T) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "HIMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flux of gas particles through spherical shells weighted by HI fraction. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "MetalMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flux of gas particles through spherical shells weighted by metal fraction. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "StellarMassFlux": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flux of star particles through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "ColdGasEnergyFlux": (
            ...
            np.float32,
            "snap_mass*snap_length**2/snap_time**3",
            "Energy flux of cold gas particles (log T < 3) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "CoolGasEnergyFlux": (
            ...
            np.float32,
            "snap_mass*snap_length**2/snap_time**3",
            "Energy flux of cool gas particles (3 < log T < 5) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "WarmGasEnergyFlux": (
            ...
            np.float32,
            "snap_mass*snap_length**2/snap_time**3",
            "Energy flux of warm gas particles (5 < log T < 7) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "HotGasEnergyFlux": (
            ...
            np.float32,
            "snap_mass*snap_length**2/snap_time**3",
            "Energy flux of hot gas particles (7 < log T) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "ColdGasMomentumFlux": (
            ...
            "Momentum flux of cold gas particles (log T < 3) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "CoolGasMomentumFlux": (
            ...
            np.float32,
            "snap_mass*snap_length/snap_time**2",
            "Momentum flux of cool gas particles (3 < log T < 5) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "WarmGasMomentumFlux": (
            ...
            np.float32,
            "snap_mass*snap_length/snap_time**2",
            "Momentum flux of warm gas particles (5 < log T < 7) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "HotGasMomentumFlux": (
            ...
            np.float32,
            "snap_mass*snap_length/snap_time**2",
            "Momentum flux of hot gas particles (7 < log T) through spherical shells. Contains 6 entries: outflow rate at 0.1R, inflow rate at 0.1R, outflow rate at 0.3R, inflow rate at 0.3R, outflow rate at 0.95R, inflow rate at 0.95R.",
            "general",
            "FMantissa9",
            False,
            [
