...
class PropertyTable:
    ...
    full_property_list = {
        ...
        "gasNfrac": (
            "GasMassFractionInNitrogen",
            1,
            np.float32,
            "dimensionless",
            "Total gas mass in nitrogen.",
            "gas",
            "FMantissa9",
            False,
            ["PartType0/Masses", "PartType0/ElementMassFractions"],
        ...
        "starNfrac": (
            "StellarMassFractionInNitrogen",
            1,
            np.float32,
            "dimensionless",
            "Total stellar mass fraction in nitrogen.",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Masses", "PartType4/ElementMassFractions"],
        ...
        "LinearMassWeightedNitrogenOverOxygenOfGas": (
            ...
            np.float32,
            "Msun",
            "Linear sum of the nitrogen over oxygen ratio of gas, multiplied with the gas mass.",
            "gas",
            "FMantissa9",
            False,
            [
        ...
        "LinearMassWeightedCarbonOverOxygenOfGas": (
            ...
            np.float32,
            "Msun",
            "Linear sum of the carbon over oxygen ratio of gas, multiplied with the gas mass.",
            "gas",
            "FMantissa9",
            False,
            [
        ...
        "LogarithmicMassWeightedNitrogenOverOxygenOfGasLowLimit": (
            ...
            np.float32,
            "Msun",
            "Logarithmic sum of the total nitrogen over oxygen ratio of gas, multiplied with the gas mass. Imposes a lower limit of 1.e-4 times solar N/O.",
            "gas",
            "FMantissa9",
            False,
            [
        ...
        "LogarithmicMassWeightedNitrogenOverOxygenOfGasHighLimit": (
            ...
            np.float32,
            "Msun",
            "Logarithmic sum of the total nitrogen over oxygen ratio of gas, multiplied with the gas mass. Imposes a lower limit of 1.e-3 times solar N/O.",
            "gas",
            "FMantissa9",
            False,
            [
        ...
        "LogarithmicMassWeightedCarbonOverOxygenOfGasLowLimit": (
            ...
            np.float32,
            "Msun",
            "Logarithmic sum of the total carbon over oxygen ratio of gas, multiplied with the gas mass. Imposes a lower limit of 1.e-4 times solar C/O.",
            "gas",
            "FMantissa9",
            False,
            [
        ...
        "LogarithmicMassWeightedCarbonOverOxygenOfGasHighLimit": (
            ...
            np.float32,
            "Msun",
            "Logarithmic sum of the total carbon over oxygen ratio of gas, multiplied with the gas mass. Imposes a lower limit of 1.e-3 times solar C/O.",
            "gas",
            "FMantissa9",
            False,
            [
