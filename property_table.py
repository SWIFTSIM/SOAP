...
class PropertyTable:
    ...
    full_property_list = {
        ...
        "AveragedStarFormationRate": (
            ...
            np.float32,
            "snap_mass/snap_time",
            "Total star formation rate, averaged over past 100Myr and past 10Myr. If the time between this snapshot and the previous one was less than the averaging time, then the value is averaged over the time between the snapshots.",
            "basic",
            "FMantissa9",
            False,
        ...
        "CorrectedStellarLuminosity": (
            ...
            np.float32,
            "dimensionless",
            "IMF-corrected total stellar luminosity in the bands SDSS-r, SDSS-u, SDSS-z, VISTA-k, GALEX-FUV (x 3 nebular emissions).",
            "star",
            "FMantissa9",
            False,
        ...
        "CorrectedStellarLuminosityWithDust": (
            ...
            np.float32,
            "dimensionless",
            "IMF-corrected total stellar luminosity with dust attenuation in the bands SDSS-r, SDSS-u, SDSS-z, VISTA-k, GALEX-FUV (x 3 nebular emissions).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/CorrectedLuminositiesWithDust"],
            True,
            None,
        ),
        "ChabrierInferredMstar": (
            "ChabrierInferredStellarMass",
            1,
            np.float32,
            "snap_mass",
            "Total stellar mass, modified for a Chabrier IMF",
            "basic",
            "FMantissa9",
            False,
            ["PartType4/ChabrierMasses"],
            True,
            0,
        ),
        "Tgas": (
        ...
        "DarkMatterMassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of dark matter particles through spherical shells. Contains 6 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            True,
            ["PartType1/Coordinates", "PartType1/Masses", "PartType1/Velocities"],
        ...
        "ColdGasMassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of cold gas particles (log T < 3) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "CoolGasMassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of cool gas particles (3 < log T < 5) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "WarmGasMassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of warm gas particles (5 < log T < 7) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "HotGasMassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of hot gas particles (7 < log T) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "HIMassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of gas particles through spherical shells weighted by HI fraction. Contains 6 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "H2MassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of gas particles through spherical shells weighted by H2 fraction. Does not include Helium. Contains 6 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "MetalMassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of gas particles through spherical shells weighted by metal fraction. Contains 6 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "StellarMassFlowRate": (
            ...
            np.float32,
            "snap_mass / snap_time",
            "Mass flow rate of star particles through spherical shells. Contains 6 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses", "PartType4/Velocities"],
        ...
        "ColdGasEnergyFlowRate": (
            ...
            np.float32,
            "snap_mass*snap_length**2/snap_time**3",
            "Energy flow rate of cold gas particles (log T < 3) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "CoolGasEnergyFlowRate": (
            ...
            np.float32,
            "snap_mass*snap_length**2/snap_time**3",
            "Energy flow rate of cool gas particles (3 < log T < 5) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "WarmGasEnergyFlowRate": (
            ...
            np.float32,
            "snap_mass*snap_length**2/snap_time**3",
            "Energy flow rate of warm gas particles (5 < log T < 7) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "HotGasEnergyFlowRate": (
            ...
            np.float32,
            "snap_mass*snap_length**2/snap_time**3",
            "Energy flow rate of hot gas particles (7 < log T) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "ColdGasMomentumFlowRate": (
            ...
            "Momentum flow rate of cold gas particles (log T < 3) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "CoolGasMomentumFlowRate": (
            ...
            np.float32,
            "snap_mass*snap_length/snap_time**2",
            "Momentum flow rate of cool gas particles (3 < log T < 5) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "WarmGasMomentumFlowRate": (
            ...
            np.float32,
            "snap_mass*snap_length/snap_time**2",
            "Momentum flow rate of warm gas particles (5 < log T < 7) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "HotGasMomentumFlowRate": (
            ...
            np.float32,
            "snap_mass*snap_length/snap_time**2",
            "Momentum flow rate of hot gas particles (7 < log T) through spherical shells. Contains 9 entries: inflow rate at 0.1R, 0.3R, R, outflow rate at 0.1R, 0.3R, R, fast outflow rate at 0.1R, 0.3R, R.",
            "general",
            "FMantissa9",
            False,
            [
        ...
        "stellar_age_uvlw": (
            "UVLuminosityWeightedMeanStellarAge",
            1,
            np.float32,
            "snap_time",
            "Luminosity weighted mean stellar age. The weight is the IMF-corrected FUV band luminosity.",
            "star",
            "FMantissa9",
            False,
            ["PartType4/CorrectedLuminosities", "PartType4/BirthScaleFactors"],
            True,
            None,
        ),
        "stellar_age_mw": (
        ...
        "LinearMassWeightedMagnesiumOverHydrogenOfStars": (
            ...
            np.float32,
            "dimensionless",
            "Linear sum of the magnesium over hydrogen ratio of stars, multiplied with the stellar mass.",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Masses", "PartType4/ElementMassFractions"],
        ...
        "LogarithmicMassWeightedMagnesiumOverHydrogenOfStarsLowLimit": (
            ...
            np.float32,
            "dimensionless",
            "Logarithmic sum of the magnesium over hydrogen ratio of stars, multiplied with the stellar mass. Imposes a lower limit of 1.e-4 times solar Fe/H.",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Masses", "PartType4/ElementMassFractions"],
        ...
        "LogarithmicMassWeightedMagnesiumOverHydrogenOfStarsHighLimit": (
            ...
            np.float32,
            "dimensionless",
            "Logarithmic sum of the magnesium over hydrogen ratio of stars, multiplied with the stellar mass. Imposes a lower limit of 1.e-3 times solar Fe/H.",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Masses", "PartType4/ElementMassFractions"],
    ...
    soap_properties = [
        name for name, info in full_property_list.items() if info[5] == "SOAP"
    ]
