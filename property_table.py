...
class PropertyTable:
    ...
    full_property_list = {
        ...
        "LogarithmicMassWeightedDiffuseOxygenOverHydrogenOfGas": (
            ...
            np.float32,
            "Msun",
            "Logarithmic sum of the diffuse oxygen over hydrogen ratio of gas, multiplied with the gas mass.",
            "gas",
            "FMantissa9",
            False,
            [
        ...
        "LogarithmicMassWeightedDiffuseOxygenOverHydrogenOfAtomicGas": (
            ...
            np.float32,
            "Msun",
            "Logarithmic sum of the diffuse oxygen over hydrogen ratio of atomic gas, multiplied with the gas mass.",
            "gas",
            "FMantissa9",
            False,
            [
        ...
        "LogarithmicMassWeightedDiffuseOxygenOverHydrogenOfMolecularGas": (
            ...
            np.float32,
            "Msun",
            "Logarithmic sum of the diffuse oxygen over hydrogen ratio of molecular gas, multiplied with the gas mass.",
            "gas",
            "FMantissa9",
            False,
            [
