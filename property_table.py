...
class PropertyTable:
    ...
    full_property_list = {
        ...
        "DarkMatterInertiaTensor": (
            ...
            np.float32,
            "kpc**2",
            "3D inertia tensor computed iteratively from the DM mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "dm",
            "FMantissa9",
            True,
        ...
        "DarkMatterInertiaTensorReduced": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 3D inertia tensor computed iteratively from the DM mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "dm",
            "FMantissa9",
            True,
            ["PartType1/Coordinates", "PartType1/Masses"],
        ...
        "DarkMatterInertiaTensorNoniterative": (
            ...
            np.float32,
            "kpc**2",
            "3D inertia tensor computed in a single interation from the DM mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "dm",
            "FMantissa9",
            True,
            ["PartType1/Coordinates", "PartType1/Masses"],
        ...
        "DarkMatterInertiaTensorReducedNoniterative": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 3D inertia tensor computed in a single interation from the DM mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "dm",
            "FMantissa9",
            True,
            ["PartType1/Coordinates", "PartType1/Masses"],
        ...
        "GasInertiaTensor": (
            ...
            np.float32,
            "kpc**2",
            "3D inertia tensor computed iteratively from the gas mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "gas",
            "FMantissa9",
            False,
        ...
        "GasInertiaTensorReduced": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 3D inertia tensor computed iteratively from the gas mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "gas",
            "FMantissa9",
            False,
            ["PartType0/Coordinates", "PartType0/Masses"],
        ...
        "GasInertiaTensorNoniterative": (
            ...
            np.float32,
            "kpc**2",
            "3D inertia tensor computed in a single iteration from the gas mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "gas",
            "FMantissa9",
            False,
            ["PartType0/Coordinates", "PartType0/Masses"],
        ...
        "GasInertiaTensorReducedNoniterative": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 3D inertia tensor computed in a single iteration from the gas mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "gas",
            "FMantissa9",
            False,
            ["PartType0/Coordinates", "PartType0/Masses"],
        ...
        "ProjectedGasInertiaTensor": (
            ...
            np.float32,
            "kpc**2",
            "2D inertia tensor computed iteratively from the gas mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "gas",
            "FMantissa9",
            False,
            ["PartType0/Coordinates", "PartType0/Masses"],
        ...
        "ProjectedGasInertiaTensorReduced": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 2D inertia tensor computed iteratively from the gas mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "gas",
            "FMantissa9",
            False,
            ["PartType0/Coordinates", "PartType0/Masses"],
        ...
        "ProjectedGasInertiaTensorNoniterative": (
            ...
            np.float32,
            "kpc**2",
            "2D inertia tensor computed in a single iteration from the gas mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "gas",
            "FMantissa9",
            False,
            ["PartType0/Coordinates", "PartType0/Masses"],
        ...
        "ProjectedGasInertiaTensorReducedNoniterative": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 2D inertia tensor computed in a single iteration from the gas mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "gas",
            "FMantissa9",
            False,
            ["PartType0/Coordinates", "PartType0/Masses"],
        ...
        "ProjectedStellarInertiaTensor": (
            ...
            np.float32,
            "kpc**2",
            "2D inertia tensor computed iteratively from the stellar mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses"],
        ...
        "ProjectedStellarInertiaTensorReduced": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 2D inertia tensor computed iteratively from the stellar mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses"],
        ...
        "ProjectedStellarInertiaTensorNoniterative": (
            ...
            np.float32,
            "kpc**2",
            "2D inertia tensor computed in a single iteration from the stellar mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses"],
        ...
        "ProjectedStellarInertiaTensorReducedNoniterative": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 2D inertia tensor computed in a single iteration from the stellar mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses"],
        ...
        "StellarInertiaTensor": (
            ...
            np.float32,
            "kpc**2",
            "3D inertia tensor computed iteratively from the stellar mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses"],
        ...
        "StellarInertiaTensorReduced": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 3D inertia tensor computed iteratively from the stellar mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses"],
        ...
        "StellarInertiaTensorNoniterative": (
            ...
            np.float32,
            "kpc**2",
            "3D inertia tensor computed in a single iteration from the stellar mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses"],
        ...
        "StellarInertiaTensorReducedNoniterative": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 3D inertia tensor computed in a single iteration from the stellar mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "star",
            "FMantissa9",
            False,
            ["PartType4/Coordinates", "PartType4/Masses"],
        ...
        "TotalInertiaTensor": (
            ...
            np.float32,
            "kpc**2",
            "3D inertia tensor computed iteratively from the total mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "general",
            "FMantissa9",
            True,
            [
        ...
        "TotalInertiaTensorReduced": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 3D inertia tensor computed iteratively from the total mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "general",
            "FMantissa9",
            True,
            [
        ...
        "TotalInertiaTensorNoniterative": (
            ...
            np.float32,
            "kpc**2",
            "3D inertia tensor computed in a single iteration from the total mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "general",
            "FMantissa9",
            True,
            [
        ...
        "TotalInertiaTensorReducedNoniterative": (
            ...
            np.float32,
            "dimensionless",
            "Reduced 3D inertia tensor computed in a single iteration from the total mass distribution, relative to the halo centre. Diagonal components and one off-diagonal triangle as (1,1), (2,2), (3,3), (1,2), (1,3), (2,3).",
            "general",
            "FMantissa9",
            True,
            [
