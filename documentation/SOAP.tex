...
SOAP computes properties for lots of different definition of halo types. This is how we select the
particles to use when computing the properties. There are two decisions to made - firstly whether
to include particles which are unbound. Secondly to exclude particles which are outside of a certain
aperture.
