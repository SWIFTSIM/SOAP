...
parser = argparse.ArgumentParser(description="Generates plots to identify where SOAP spent its time.")
parser.add_argument(
    "soap_catalogue",
    type=str,
    help="Filepath to SOAP catalogue to analyse"
)
parser.add_argument(
    "-o", "--output", 
    type=str, 
...
plot_time_vs_nbound(
    n_process,
    'Number of times the subhalo was processed',
    'Nprocess'
)
plot_time_vs_nbound(
