...
The `property_table.py` script also generates the file `documentation/properties.rst`, which is a version of the property table that can be useful for sphnix websites.
